...
<head>
	...
	<title>Sistem Management Pelanggan</title>
...
<body onload="initMap()">
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
         ...
         <img src="{{asset('uinsu.jpeg')}}" style="width:200px"><br><br><span>Sistem Informasi <br>Management pelanggan</span>
        </a>
			...
			<!--		<li class="sidebar-item">
              ...
              <i class="align-middle" data-feather="align-left"></i> <span class="center-middle">Typography</span>
            </a>
					</li>
